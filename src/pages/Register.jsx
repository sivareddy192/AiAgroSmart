...
import { FaSeedling, FaLock, FaEnvelope, FaUserPlus, FaExclamationTriangle } from "react-icons/fa";
...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      alert("Account created successfully! Let's login.");
      navigate("/login");
    } catch (err) {
    ...
    <div className="auth-page bg-gradient-radial">
      ...
      >
        <div className="auth-header">
          ...
          <p>Join AgroSmart and start farming smarter 🌱</p>
        </div>
